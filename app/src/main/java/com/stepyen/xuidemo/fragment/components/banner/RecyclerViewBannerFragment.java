...
import com.stepyen.xuidemo.adapter.RecyclerViewBannerAdapter;
...
public class RecyclerViewBannerFragment extends BaseFragment implements BannerLayout.OnBannerItemClickListener {
    ...
    protected void initViews() {
        blHorizontal.setAdapter( mAdapterHorizontal = new RecyclerViewBannerAdapter(DataProvider.urls) );
        blVertical.setAdapter(mAdapterVertical =  new RecyclerViewBannerAdapter(DataProvider.urls));
    }
