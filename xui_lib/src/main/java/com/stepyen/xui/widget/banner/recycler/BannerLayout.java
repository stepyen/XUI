...
package com.stepyen.xui.widget.banner.recycler;
...
import com.stepyen.xui.widget.banner.recycler.layout.BannerLayoutManager;
import com.stepyen.xui.widget.banner.recycler.layout.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int indicatorUnselectedColor = a.getColor(R.styleable.BannerLayout_bl_indicatorUnselectedColor, ResUtils.getColor(R.color.xui_gray_2));
