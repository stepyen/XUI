...
import com.stepyen.xui.widget.imageview.photoview.PhotoViewAttacher;
...
public class BasePhotoFragment extends Fragment {
    ...
    private void initArgs() {
        ...
        if (bundle != null) {
            isSingleFling = bundle.getBoolean(KEY_SING_FILING,true);
            //地址
            mPreviewInfo = bundle.getParcelable(KEY_PREVIEW_ITEM);
            //位置
            assert mPreviewInfo != null;
            mImageView.setDrag(bundle.getBoolean(KEY_DRAG,true), bundle.getFloat(KEY_SENSITIVITY));
