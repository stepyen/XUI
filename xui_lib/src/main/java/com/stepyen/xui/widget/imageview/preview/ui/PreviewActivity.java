...
import com.stepyen.xui.widget.imageview.preview.view.BezierBannerView;
import com.stepyen.xui.widget.imageview.preview.view.PhotoViewPager;
import com.stepyen.xui.R;
import com.stepyen.xui.widget.imageview.preview.MediaLoader;
            ...
            for (int i = 0; i < size; i++) {
                fragments.add(BasePhotoFragment.
                        newInstance(className, imgUrls.get(i),
                                currentIndex == i,
                                getIntent().getBooleanExtra(KEY_SING_FILING, true),
                                getIntent().getBooleanExtra(KEY_DRAG, true),
